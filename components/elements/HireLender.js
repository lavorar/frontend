    ...
    return (
        <div className=''>
            {serviceHire?.length ?
                <button
                    type="button"
                    className="py-[0.6rem] px-3 my-2 text-base font-medium text-gray-900 focus:outline-none bg-white rounded-lg  hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-300  dark:hover:text-white dark:hover:bg-gray-700"
                >
                    Contratado
                </button>
                :
